...
def main(unused_argv):
    ...
    _TRAIN_DATA_SOURCES = {"input": _TRAIN_TAG + '.bpe.' + str(FLAGS.search) + "." + FLAGS.fro,
                           "target": _TRAIN_TAG + '.bpe.' + str(FLAGS.search) + "." + FLAGS.to}
    _EVAL_DATA_SOURCES = {"input": _EVAL_TAG + '.bpe.' + str(FLAGS.search) + "." + FLAGS.fro,
                          "target": _EVAL_TAG + '.bpe.' + str(FLAGS.search) + "." + FLAGS.to}
    _VOCAB_DATA_SOURCES = {"input": 'vocab.bpe.'+str(FLAGS.search)+"."+FLAGS.fro,
                           "target":'vocab.bpe.'+str(FLAGS.search)+"."+FLAGS.to,}
    ...
    vocab_file_source = os.path.join(FLAGS.data_dir, 'vocab' + '.bpe.' + str(FLAGS.search) + '.' + FLAGS.fro)
    vocab_file_target = os.path.join(FLAGS.data_dir, 'vocab' + '.bpe.' + str(FLAGS.search) + '.' + FLAGS.to)
