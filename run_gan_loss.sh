...
# sharing embedding
python3 main_gan_loss.py \
    --num_gpus 2 \
    --roll_num 5 \
    --param_set base \
    --data_dir /home/work/xiepan/xp_dial/gan_nmt/transformer_rl/data/en-tr/v1/gen_data \
    --model_dir /home/work/xiepan/xp_dial/gan_nmt/transformer_rl_sess/model_save/en-tr/share/base/train_gan_loss \
    --pretrain_dir /home/work/xiepan/xp_dial/gan_nmt/transformer_rl_sess/model_save/en-tr/share/base/train_base_loss \
    --learning_rate 2.0 \
    --batch_size  3000 \
    --max_length 50 \
    --fro src \
