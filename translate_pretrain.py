...
def main(unused_argv):
    import transformer_pretrain_main
    ...
    params = transformer_pretrain_main.PARAMS_MAP[FLAGS.param_set]
    ...
    if params.shared_embedding_softmax_weights:
        ...
        tf.logging.info("source vocab_size is {}, target vocab_size is {}".format(params.source_vocab_size, params.target_vocab_size))


    estimator = tf.estimator.Estimator(
        model_fn=transformer_pretrain_main.pretrain_model_fn, model_dir=FLAGS.model_dir,
        params=params)
